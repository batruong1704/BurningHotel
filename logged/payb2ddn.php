...
<body onunload="myFunction()">
    ...
    <form action="" method="POST">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-6">
                        <div style="width:60%;padding-left:200px">
                            <input type="text" id="thanhtoantruoc" name="thanhtoantruoc" style="display:flex;width:100%;background-color: #181A1B;color:brown;border:none;border-bottom: 1px solid #525354;font-family:Montserrat-Regular" placeholder="Nhập số tiền tại đây" required>
                        </div>
                    </div>
                </div>
        ...
        <input type="hidden" id="ngayDen" name="ngayDen" value="">
        <input type="hidden" id="ngayDi" name="ngayDi" value="">
        <input type="hidden" id="stpt" name="stpt" value="">

        <section id="button">
            <div class="pb-3"><button type="submit" onclick="return kiemtrathanhtoan()" name="btn" style="font-family:Montserrat-Regular;">Thanh Toán</button></div>
        </section>
    </form>
    <script>
        ...
        document.getElementById("ngayDen").value = ngayDen.toISOString().split('T')[0];
        document.getElementById("ngayDi").value = ngayDi.toISOString().split('T')[0];
        document.getElementById("stpt").value = sotienphaitra;
