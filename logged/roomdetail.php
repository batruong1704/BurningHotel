...
<body>
    ...
    <section id="information">
        <div class="container text-center">
            <div class="row">
                <div class="col-9">
                    <p class="p-5" style="font-family:Montserrat-Regular;">Phòng Deluxe nằm từ tầng 7 đến tầng 16, với diện tích
                ...
                <div class="col-3 d-flex align-items-center justify-content-end">
                    <div class="">
                    <a style="text-decoration:none; color:white; font-weight: 500;" href="payddn.php?MaPhong=<?php echo $MaPhong ?>"><button class="bookingnow">BOOKING NOW</button></a>
                    </div>
                </div>
            </div>
                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="true">
                    <div class="carousel-inner">
                        <div class="slide-item carousel-item active">
                            <img src="<?php echo $IMG ?>" class="d-block w-100 rounded-3" style="height: 450px;" alt="">
