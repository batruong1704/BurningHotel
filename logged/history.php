            ...
            <?php foreach ($lichsuphongs as $key => $value) {
                ...
                <div class="mainroom_1">
                    ...
                    <div class="mainroom11">
                        <p class="mainroom111">
                            <?php echo $value['KieuPhong'] ?>
                        </p>
                        <p class="mainroom112">Tổng Số Tiền :
                            <?php echo $value['TongTien'] ?> VNĐ
                        </p>
                        <p class="mainroom112">Ngày Đến - Ngày Đi:
                            <?php echo $ngayden . ' / ' . $ngaydi ?>
                        </p>
                        <p class="mainroom112">Ngày đặt phòng:
                            <?php echo $ngaythanhtoan ?>
                        </p>
                    </div>
                    <div class="mainroom13">
                        ...
                        <div> <a style="text-decoration: none "
                                href="thongtinphong.php?MaPDP=<?php echo $value['MaPDP'] ?>">Xem chi tiết</a></div>
                        <div> <a id="huyphong" style="text-decoration: none "
                                href="HuyDatPhong.php?MaPDP=<?php echo $value['MaPDP']; ?>&MaPDV=<?php echo $value['MaPDV']; ?>"
                                onclick="return confirm('Bạn có chắc chắn muốn hủy đặt phòng?')">Hủy Đặt Phòng</a> </div>
                    </div>
                </div>
                <script>
